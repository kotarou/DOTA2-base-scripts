...
function Activate()
    ...
    GameRules.AddonTemplate = k_GameMode()
...
function k_GameMode:InitGameMode()
    ...
    ListenToGameEvent('player_connect_full', Dynamic_Wrap(k_GameMode, 'OnPlayerConnectFull'), self)
...
function k_GameMode:OnThink()
    --print(GameRules:State_Get())
    return GAME_TICK_TIME
end

function k_GameMode:OnPlayerConnectFull(keys)
